...
const AP_Param::GroupInfo AP_ExternalAHRS::var_info[] = {
    ...
    // @Values: 0:None,1:VectorNav,2:MicroStrain5,5:InertialLabs,6:Trimble GSOF,7:MicroStrain7,8:SBG,11:SensAItion,12:DM-IMU
    // @User: Standard
...
void AP_ExternalAHRS::init(void)
{
    ...
    case DevType::DMIMU:
        backend = NEW_NOTHROW AP_ExternalAHRS_DMIMU(this, state);
        return;
#endif
